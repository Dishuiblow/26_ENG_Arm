...
//  // 【修复2】判断 HS 实例 (H723 PA11/12 属于 HS 实例)
//  if(pcdHandle->Instance == USB_OTG_HS)
//  {
//    /* 1. 开启时钟 */
//    __HAL_RCC_GPIOA_CLK_ENABLE();      // 开启 GPIOA
//    __HAL_RCC_USB_OTG_HS_CLK_ENABLE(); // 【修复3】开启 HS 时钟 (不是 FS)
...
//    GPIO_InitStruct.Alternate = GPIO_AF10_OTG1_HS; // 复用为 OTG1_HS
//    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

//    /* 3. 配置中断 */
//    HAL_NVIC_SetPriority(OTG_HS_IRQn, 6, 0); // 【修复4】使用 HS 中断号
